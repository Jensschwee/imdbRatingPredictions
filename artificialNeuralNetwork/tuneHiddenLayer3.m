...
for numHidden = hiddenNeuronRange
    for numHidden1 = hiddenNeuronRange
        numHidden
        numHidden1
        hiddenNeurons = [100 numHidden numHidden1];
        ...
        hiddenLayerName = [hiddenLayerName, {strcat(num2str(100),'--',num2str(numHidden),'--',num2str(numHidden1))}];
